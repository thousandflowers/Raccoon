...
var (
	styleTitle = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#e8b86d")). // honey gold
			Bold(true)

	styleDesc = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#8a7d6e")) // warm gray
	...
	styleFooter = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#6a5f52")) // muted warm
	...
	styleOutput = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#d6c8b6")) // warm cream

	styleOutputBullet = lipgloss.NewStyle().
				Foreground(lipgloss.Color("#6a5f52")) // muted bullet

	styleError = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#c9584a")) // warm rose

	styleSuccess = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#9bb87e")) // soft sage

	styleWarning = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#d4a74b")) // warm gold

	styleMuted = lipgloss.NewStyle().
			Foreground(lipgloss.Color("#4a4038")) // dark muted

	styleProgressEmpty = lipgloss.NewStyle().
				Foreground(lipgloss.Color("#3a322c")) // empty bar track

	styleProgressFill = lipgloss.NewStyle().
				Foreground(lipgloss.Color("#d4904b")) // amber fill
